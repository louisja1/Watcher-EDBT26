...
def main():
    ...
    query_db = QueryDB("jgmp-query-optimization", port=args.port)
    ...
    if args.type == 'cross-validation':
        ...
        if args.query_set == 'job-light':
            ...
            dsb_test("/winhomes/yl762/jgmp/data/dsb", configs, subplan_query_mode, 10, repetitions=repetitions, num_parts=num_parts, port=args.port)
        else:
            raise NotImplementedError()
