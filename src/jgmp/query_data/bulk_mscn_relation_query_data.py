...
from jgmp.query_data.bulk_query_data import BulkQueryData


class BulkMSCNRelationQueryData(BulkMSCNQueryData):
    def __init__(self,
        ...
        super(BulkMSCNRelationQueryData, self).__init__(node_index,
                                                        edge_index,
                                                        edge_labels,
                                                        shared_node_labels,
