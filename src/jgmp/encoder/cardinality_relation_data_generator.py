...
from jgmp.query.symmetry.cardinality_relation import RelationType, CardinalityRelation
...
from jgmp.query_data.cardinality_relation_query_data import CardinalityRelationQueryData
