...
from jgmp.schema.random_attribute_buffer import RandomAttributeBuffer
...
class SQLRandomAttributeBuffer(RandomAttributeBuffer):
    def __init__(self, schema: SQLSchema, buffer_size: int = 1000, seed: Optional[int] = 2023) -> None:
