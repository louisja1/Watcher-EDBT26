...
def get_single_table_pointer(sql):
    ...
    with open("/winhomes/ANONYMOUS/watcher_data/single_tbl_est_record.txt", "r") as fin:
        q_id = None
        single_tab_to_qid = {}
...
def get_two_way_join_info(sql, tableset):
    ...
    with open("/winhomes/ANONYMOUS/watcher_data/join_est_record_job.txt", "r") as fin:
        q_id = None
        raw_rows = None
        relation_names = []
        min_join_qid = None
...
def inject_single_table_sels_and_get_cost(pointer, sel, n_tabs_in_from, q, hint, plan_info):
    sels_filename = "/winhomes/ANONYMOUS/watcher_data/sels.txt"
    pointers_filename = "/winhomes/ANONYMOUS/watcher_data/pointers.txt"
...
def inject_join_sel_and_get_cost(join_pointer, join_sel, min_join_qid, max_join_qid, q, hint, plan_info):
    single_sels_filename = "/winhomes/ANONYMOUS/watcher_data/sels.txt"
    join_sels_filename = "/winhomes/ANONYMOUS/watcher_data/join.txt"
    pointers_filename = "/winhomes/ANONYMOUS/watcher_data/pointers.txt"
...
def inject_true_cards_and_get_cost(
    ...
    sels_filename = "/winhomes/ANONYMOUS/watcher_data/sels.txt"
    join_filename = "/winhomes/ANONYMOUS/watcher_data/join.txt"
    pointers_filename = "/winhomes/ANONYMOUS/watcher_data/pointers.txt"
...
def inject_single_and_join_sels_and_get_cost(pointers, single_sels, n_single, join_sels, n_all, q, hint, plan_info):
    single_filename = "/winhomes/ANONYMOUS/watcher_data/sels.txt"
    join_filename = "/winhomes/ANONYMOUS/watcher_data/join.txt"
    pointers_filename = "/winhomes/ANONYMOUS/watcher_data/pointers.txt"
...
def get_plan_cost(
    ...
    os.system("rm /winhomes/ANONYMOUS/watcher_data/join_est_record_job.txt")
    os.system("rm /winhomes/ANONYMOUS/watcher_data/single_tbl_est_record.txt")
...
def get_real_latency(
    ...
    for T in range(n_repetitions):
        ...
        os.system("rm -f /winhomes/ANONYMOUS/watcher_data/join_est_record_job.txt")
        os.system("rm -f /winhomes/ANONYMOUS/watcher_data/single_tbl_est_record.txt")
        cursor.execute("SET print_single_tbl_queries=true;")
        cursor.execute("SET print_sub_queries=true;")
...
def load_pg_join_subquery_info():
        ...
        with open("/winhomes/ANONYMOUS/watcher_data/join_est_record_job.txt", "r") as test_fin:
